...
namespace HMV.Core.Framework.Cache
{
    public class HMVCache : ICache
    {
        private readonly static ICacheManager _CacheManager = CacheFactory.GetCacheManager("HMVCache");
