                    ...
                    switch (xamlReader.NodeType)
                    {
                        ...
                        case XmlNodeType.SignificantWhitespace:
                            if (htmlWriter != null)
                            {
                                ...
                                //htmlWriter.WriteString(xamlReader.Value/*.Replace(Environment.NewLine, "<br>")*/);
                                htmlWriter.WriteString(xamlReader.Value
                                    //.Replace(Environment.NewLine, "<br/>")
                                    //.Replace(Convert.ToString(Convert.ToChar(10)), "<br/>")
                                    );
                                //strReturn.Replace(Convert.ToString(Convert.ToChar(10)), "<br />");
                            }
                            elementContentStarted = true;
                            break;
                    }
