...
{
    public class SaveRegistrosDeEvolucaoCommand : ICommand
    {
        ...
        public SaveRegistrosDeEvolucaoCommand(object pViewModel)
        {
        ...
        public void Execute(object parameter)
        {
            ...
            if (ViewModel.GetType() == typeof(vmRegistrosDeEvolucao))
            {
                (ViewModel as vmRegistrosDeEvolucao).Save();
            }
        }
        #endregion
    }
