...
{
    public class vmResumoDoProntuario : ViewModelBase
    {
        #region Contrutor
        public vmResumoDoProntuario(Paciente paciente)
        {
        ...
        public vmResumoDoProntuario(Paciente paciente, int atend)
        {
            this._paciente = new wrpPaciente(paciente);
