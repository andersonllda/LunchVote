...
namespace LunchVote.Core.Commands
{
    /// <summary>
    ...
    public class CommandMap
    {
        ...
        public void AddCommand(enumCommand commandName, Action<object> executeMethod)
        {
            Commands[commandName.ToString()] = new DelegateCommand(executeMethod);
        }
        ...
        public void AddCommand(enumCommand commandName, Action<object> executeMethod, Predicate<object> canExecuteMethod)
        {
            Commands[commandName.ToString()] = new DelegateCommand(executeMethod, canExecuteMethod);
        }
        ...
        /// </summary>
        /// <param name="commandName">The name of the command</param>
        public void RemoveCommand(enumCommand commandName)
        {
            Commands.Remove(commandName.ToString());
        }
        ...
        public void ExecuteCommand(enumCommand commandName, object parameter)
        {
            Commands[commandName.ToString()].Execute(parameter);
        }
